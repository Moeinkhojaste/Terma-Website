    ...
    public async Task SeedAsync(CancellationToken cancellationToken = default)
    {
        ...
        await AddAsync("site-settings", "تنظیمات عمومی سایت", true, new CmsDocumentDto
        {
            ...
            [
                ...
                Block("contactInfo", new { brandName = "ترما", tagline = Legacy("common", "footer_tagline", "سفره‌های ترمه برای خانه‌های ایرانی امروز", body: true), email = "info@terma.ir", phone = "", instagramUrl = "", responseHours = "شنبه تا چهارشنبه، ۹ تا ۱۸", logoUrl = "/images/terma-logo.webp" }),
        ...
        await AddAsync("home", "صفحه اصلی", true, new CmsDocumentDto
        {
            ...
            Blocks =
            [
                Block("hero", new { eyebrow = "ترمه، برای خانه امروز", title = Legacy("home", "hero", "نقش ایرانی، در خانه شما"), text = Legacy("home", "hero", "سفره‌های ترمه با آستر ساتن و لبه‌دوزی دقیق؛ برای پهن‌کردن روی میز یا روی زمین.", true), imageUrl = "/images/firoozeh-folded.webp", imageAlt = "سفره ترمه فیروزه", primaryLabel = "دیدن محصولات", primaryHref = "/products", secondaryLabel = "راهنمای انتخاب", secondaryHref = "/#راهنمای-خرید" }),
