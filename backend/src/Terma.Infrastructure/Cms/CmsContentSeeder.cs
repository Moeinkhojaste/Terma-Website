    ...
    public async Task SeedAsync(CancellationToken cancellationToken = default)
    {
        ...
        await AddAsync("home", "صفحه اصلی", true, new CmsDocumentDto
        {
            ...
            [
                ...
                Block("imageText", new { eyebrow = "نمای واقعی محصول", title = Legacy("home", "craft", "نمای تاشده و نقش‌های قابل‌مشاهده"), text = Legacy("home", "craft", "این عکس واقعی، محصول را در حالت تاشده نشان می‌دهد. نمای روی میز در گالری محصول موجود است.", true), imageUrl = "/images/nila-folded.jpeg", imageAlt = "سفره ترمه نیلا به‌صورت تاشده", imageSide = "right" }),
