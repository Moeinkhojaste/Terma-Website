...
PROD_SMTP_HOST="${PROD_SMTP_HOST:-${SMTP_HOST:-smtppro.zoho.com}}"
PROD_SMTP_PORT="${PROD_SMTP_PORT:-${SMTP_PORT:-587}}"
PROD_SMTP_USERNAME="${PROD_SMTP_USERNAME:-${SMTP_USERNAME:-admin@termabrand.ir}}"
PROD_SMTP_PASSWORD="${PROD_SMTP_PASSWORD:-${SMTP_PASSWORD:-}}"
PROD_SMTP_ENABLE_SSL="${PROD_SMTP_ENABLE_SSL:-${SMTP_ENABLE_SSL:-true}}"
PROD_SMTP_FROM_EMAIL="${PROD_SMTP_FROM_EMAIL:-${SMTP_FROM_EMAIL:-admin@termabrand.ir}}"
PROD_SMTP_FROM_NAME="${PROD_SMTP_FROM_NAME:-${SMTP_FROM_NAME:-فروشگاه ترما}}"
PROD_SMTP_ENABLED="${PROD_SMTP_ENABLED:-${SMTP_ENABLED:-true}}"
